...
# CONFIG
# =========================
XML_FILE = "producto.xml"          # archivo XML de entrada con las secciones del producto
OUTPUT_DIR = "generated_images"    # directorio de salida para las imagenes generadas
UPDATED_XML_FILE = "producto.updated.xml"  # XML resultante con los src actualizados
...
def main():
    """Punto de entrada: parsea XML, genera prompts con Ollama y crea imagenes."""
    ...
    print(f"Producto detectado: {context.get('title', 'desconocido')}")
    ...
    print(f"Done. Tiempo total: {elapsed:.1f}s")
